    ...
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="bg-white border-b border-slate-100 px-4 py-3 flex items-center gap-3 sticky top-0 z-20">
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-400 font-medium">Referensi poin per satuan</p>
        </div>
      </div>
                    ...
                    {(items as any[]).map((item: any) => (
                      <div key={item.id} className="flex items-center justify-between p-3.5">
                        <div className="flex items-center gap-3 min-w-0 flex-1">
                          <div className="w-9 h-9 rounded-sm bg-emerald-50 flex items-center justify-center flex-shrink-0">
